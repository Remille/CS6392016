...
public class States {
    ...
    String[] getStateCapitals() {
        return stateCapitals;
    }

    String[] getStateCapitolsLongLat() {
        return stateCapitolsLongLat;
    }
}
